...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_CURRENT_YEAR,
                        VALID_CURRENT_GRADE, VALID_TAGS, VALID_PAYMENT_FEE, VALID_PAYMENT_DATE);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_CURRENT_YEAR, VALID_CURRENT_GRADE, VALID_TAGS, VALID_PAYMENT_FEE, VALID_PAYMENT_DATE);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, INVALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_CURRENT_YEAR,
                        VALID_CURRENT_GRADE, VALID_TAGS, VALID_PAYMENT_FEE, VALID_PAYMENT_DATE);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, INVALID_EMAIL, VALID_ADDRESS, VALID_CURRENT_YEAR,
                        VALID_CURRENT_GRADE, VALID_TAGS, VALID_PAYMENT_FEE, VALID_PAYMENT_DATE);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, INVALID_ADDRESS, VALID_CURRENT_YEAR,
                        VALID_CURRENT_GRADE, VALID_TAGS, VALID_PAYMENT_FEE, VALID_PAYMENT_DATE);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_CURRENT_YEAR,
                        VALID_CURRENT_GRADE, invalidTags, VALID_PAYMENT_FEE, VALID_PAYMENT_DATE);
    ...
    public void toModelType_invalidCurrentGrade_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_CURRENT_YEAR,
                        INVALID_CURRENT_GRADE, VALID_TAGS, VALID_PAYMENT_FEE, VALID_PAYMENT_DATE);
    ...
    public void toModelType_invalidPaymentFee_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_CURRENT_YEAR,
                        VALID_CURRENT_GRADE, VALID_TAGS, INVALID_PAYMENT_FEE, VALID_PAYMENT_DATE);
    ...
    public void toModelType_invalidPaymentDate_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_CURRENT_YEAR,
                        VALID_CURRENT_GRADE, VALID_TAGS, VALID_PAYMENT_FEE, INVALID_PAYMENT_DATE);
    ...
    public void toModelType_nullPaymentDate_returnsPerson() throws Exception {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_CURRENT_YEAR,
                        VALID_CURRENT_GRADE, VALID_TAGS, VALID_PAYMENT_FEE, null);
        assertEquals(BENSON, person.toModelType());
    }
}
