...
public class PersonBuilder {
    ...
    public static final String DEFAULT_CURRENT_GRADE = "C";
    ...
    public PersonBuilder() {
        ...
        tags = new HashSet<>();
        currentGrade = new CurrentGrade(DEFAULT_CURRENT_GRADE);
    }
    ...
    public Person build() {
        return new Person(name, phone, email, address, tags, currentGrade);
    }
