...
class JsonAdaptedPerson {
    ...
    public JsonAdaptedPerson(@JsonProperty("name") String name, @JsonProperty("phone") String phone,
            ...
            @JsonProperty("expectedGrade") String expectedGrade,
    ...
    public Person toModelType() throws IllegalValueException {
        ...
        if (expectedGrade == null) {
            throw new IllegalValueException(String.format(MISSING_FIELD_MESSAGE_FORMAT, ExpectedGrade.class.getSimpleName()));
        }
        ...
        return new Person(modelName, modelPhone, modelEmail, modelAddress, modelExpectedGrade, modelTags);
    }
