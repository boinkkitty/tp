...
public class SampleDataUtil {
    public static final PaymentInfo EMPTY_PAYMENT_INFO = new PaymentInfo.Builder().build();
    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                    ...
                    getTagSet("Math#FF5733"), new PaymentInfo.Builder().setPaymentFee(200)
                    .setPaymentDate("12-01-2024").setPaymentStatus("WAITING").build()),
            ...
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                    ...
                    getTagSet("Physics#4287f5", "friends"), new PaymentInfo.Builder()
                    .setPaymentFee(300).setPaymentDate("15-02-2024").setPaymentStatus("PAID").build()),
            ...
            new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                    ...
                    new PaymentInfo.Builder().setPaymentFee(600).setPaymentDate("01-04-2024").build()),
            ...
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                    ...
                    new PaymentInfo.Builder().setPaymentFee(750).setPaymentDate("18-05-2024").build()),
